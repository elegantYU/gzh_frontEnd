  ...
  <div class="wr_wrapper">
    <div class="wr_content">
      ...
      <div class="wr_form">
        <div class="wr_input">
          <label>房屋名称</label>
          <input type="text" readonly v-model="v_from.houseName" placeholder="请选择房屋信息">
          <i></i>
        </div>
        <div class="wr_input">
          <label>报修类型</label>
          <input type="text" readonly v-model="v_from.type" placeholder="请选择报修类型">
          <i></i>
        </div>
        <div class="wr_input">
          <label>标题</label>
...
export default {
  ...
  methods: {
    f_getDetail () {
      this.v_from.id = this.$route.query.id
      const params = {
        id: this.$route.query.id
      }

      this.$http
        .get('/admin/property/repair/detail', { params })
        .then(({ data: { data }}) => {
          this.v_from.houseName = data.houseName
          this.v_from.type = data.type
          this.v_from.title = data.title
          this.v_from.userName = data.userName
          this.v_from.telPhone = data.telPhone
          this.v_from.detail = data.detail

          this.v_from.startTime = ''
          this.v_from.endTime = ''
          this.v_from.img = JSON.parse(data.img)
        })
    },
    f_deleteImg (i) {
