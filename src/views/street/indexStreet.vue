  ...
  <div class="index_wrapper">
    <div class="index_container">
      ...
      <div class="index_topic">
        <h5>社区头条<span @click="f_moreTopic">更多<i></i></span></h5>
  ...
  export default {
    ...
    data () {
      return {
        v_banner: [],
        v_tools1: [
          { msg: '预警事件', path: '', icon: require('../../assets/images/index/index_wy.png') },
          { msg: '智慧政务', path: '', icon: require('../../assets/images/all/2.png') },
          { msg: '邻里共享', path: '', icon: require('../../assets/images/index/index_fk.png') },
          { msg: '诉求建议', path: '', icon: require('../../assets/images/index/index_zh.png') },
        ],
        v_topic: [],
        v_noHouse: false,
      }
    ...
    methods: {
      ...
      f_moreTopic () {
        this.$router.push({ name: 'topicStreet' })
      },
      f_moveto (v) {
      ...
      f_moveTopic (v) {
        console.log(v)
        this.$router.push({ name: 'detailStreet', query: { id: v.id }})
      },
      f_getTopic () {
        let params = {
