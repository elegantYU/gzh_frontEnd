<template>
  <div class="index_wrapper">
    <div class="index_swipe">
      <span class="index_map"><i></i>康馨园</span>
      <span class="index_notice"></span>
      <mt-swipe>
    ...
    <div class="index_topic">
      <h5>小区头条<span>更多<i></i></span></h5>
      <ul class="index_topic_item">
        <li>
          <div class="index_topic_item_left">
            <p>这还是打好啦收到货拉三打哈是理科地哈萨克老大和爱上了DHLask接阿斯大三大四的撒多撒多电话静安寺</p>
...
export default {
  ...
  data () {
    return {
      v_tools1: [
        { msg: '物业报修', path: '', icon: require('../../assets/images/index/index_wy.png') },
