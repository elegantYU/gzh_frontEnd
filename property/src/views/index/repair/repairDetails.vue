  ...
  <div class="wr_wrapper">
    <div class="wr_content">
      ...
      <div class="wr_form">
        ...
        <div class="wr_input">
          <label>状态</label>
          <div v-model="v_from.state" class="wr_input_state">{{v_from.state[0]}}</div>
        </div>
        <div class="wr_input wr_datetime">
          ...
          <div class="wr_datetime_item">
            <mu-date-input container="bottomSheet" :should-disable-date="f_startTimeRules" solo full-width  clock-type='24hr' view-type='list' v-model="v_start" type="dateTime" landscape></mu-date-input>
            <mu-date-input container="bottomSheet" :should-disable-date="f_startTimeRules" solo full-width  clock-type='24hr' view-type='list' v-model="v_end" type="dateTime" landscape></mu-date-input>
          </div>
        </div>
      </div>
      <div class="wr_detail">
